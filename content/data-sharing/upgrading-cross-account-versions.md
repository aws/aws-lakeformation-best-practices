...
| Source Account(grantor) - V2  | supported   | supported    | Sharing via Named Resources supported, LF-Tags not supported    | Sharing via Named Resources supported, LF-Tags not supported    |
...
1. Optionally you can validate the resources that are shared using RAM invites by invoking RAM API for named resource sharing. See [publc documetation](https://docs.aws.amazon.com/cli/latest/reference/ram/) for more information.
